          ...
          <li>
            <div class="tabla-precio">
              ...
              <div class="orden">
                ...
                <input type="numero" min="0" id="pase_dosdias" size="3" placeholder="0">
              </div>
            </div>
          </li>
            ...
            <li>
              <div class="tabla-precio">
                ...
                <input type="numero" min="0" id="pase_completo" size="3" placeholder="0">
              </div>
            </li>
            ...
            <li>
                <div class="tabla-precio">
                  ...
                  <input type="numero" min="0" id="pase_dia" size="3" placeholder="0">
                </div>
              </li>
        </ul>
    </div> <!--Paquetes-->
